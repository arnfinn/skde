...
For å bli kvitt denne informasjonen kan man gå inn på `Fil/Instillinger/Dokumenter` og huke av *Fjern skjult informasjon når du lukker dokumentet*. 
Lukk så dokumentet og svar *Ja* på spørsmålet om du vil fjerne informasjon. 
...
Oversettelse av Helseatlas (rapporter og faktaark) har blir gjort av [Anneli Olsbø](Anneli@allegro-as.no) ved Allegro AS. 
...
- Bruk `\usepackage[none]{hyphenat}` for å tvinge LaTeX til å ikke bryte ord. Eventuelt kan følgende kode brukes

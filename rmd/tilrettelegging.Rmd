...
- Koder hentet fra [Direktoratet for e-helse](https://ehelse.no/referansekatalog/referansekatalogen-for-e-helse#Helsefaglige%20kodeverk)
...
1. Lagre pdf, som hentes fra [Direktoratet for e-helse sine hjemmesider](https://ehelse.no/referansekatalog/referansekatalogen-for-e-helse#Helsefaglige%20kodeverk), som tekstfil (`*.txt*`).
  - Åpne dokumentet

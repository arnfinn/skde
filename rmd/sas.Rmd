...
- Med ujevne mellomrom oppdateres *Abb_macro*, og man må da kjøre stegene 1 til 4 på nytt. Vi får prøve å gi beskjed om dette internt...
- Hvis man nå begynner å skrive *auto* vil `AUTO_MACRO` kommer opp i en liste, og hvis man velger denne vil følgende tekst legge seg inn i sas-programmet ditt
```
%let filbane=\\tos-sas-skde-01\SKDE_SAS\;

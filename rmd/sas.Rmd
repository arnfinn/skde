...
3. *Import...*
4. Gå inn på `\\tos-sas-skde-01\skde_sas\felleskoder\master\makroer\` og velg *autocomplete.kmf*
5. *Close*
...
%mend macronavn;
```
- Hvis man lagrer en fil med navn `macronavn.sas` i `\\tos-sas-skde-01\SKDE_SAS\felleskoder\master\makroer\` kan andre bruke denne hvis de har kjørt følgende kode i SAS-prosjektet:
...
Bruk de formatene som ligger under `\\tos-sas-skde-01\SKDE_SAS\felleskoder\master\formater\`, som f.eks
